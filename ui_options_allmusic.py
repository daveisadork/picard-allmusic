...
# Form implementation generated from reading ui file 'options_AllMusic.ui'
#
...
class Ui_AllMusicOptionsPage(object):
    def setupUi(self, AllMusicOptionsPage):
        AllMusicOptionsPage.setObjectName("AllMusicOptionsPage")
        AllMusicOptionsPage.resize(QtCore.QSize(QtCore.QRect(0,0,305,317).size()).expandedTo(AllMusicOptionsPage.minimumSizeHint()))

        self.vboxlayout = QtGui.QVBoxLayout(AllMusicOptionsPage)
        self.vboxlayout.setMargin(9)
        self.vboxlayout.setSpacing(6)
        self.vboxlayout.setObjectName("vboxlayout")

        self.rename_files = QtGui.QGroupBox(AllMusicOptionsPage)
        ...
        self.use_album_styles = QtGui.QCheckBox(self.rename_files)
        self.use_album_styles.setObjectName("use_album_styles")
        self.vboxlayout1.addWidget(self.use_album_styles)

        self.use_artist_styles = QtGui.QCheckBox(self.rename_files)
        self.use_artist_styles.setObjectName("use_artist_styles")
        self.vboxlayout1.addWidget(self.use_artist_styles)
        self.vboxlayout.addWidget(self.rename_files)

        self.rename_files_2 = QtGui.QGroupBox(AllMusicOptionsPage)
        ...
        self.retranslateUi(AllMusicOptionsPage)
        QtCore.QMetaObject.connectSlotsByName(AllMusicOptionsPage)
        AllMusicOptionsPage.setTabOrder(self.use_album_styles,self.ignore_tags)

    def retranslateUi(self, AllMusicOptionsPage):
        self.rename_files.setTitle(_("AllMusic Genres"))
        self.use_album_styles.setText(_("Use album styles"))
        self.use_artist_styles.setText(_("Use artist styles"))
